...
class Application():
    def __init__(self, master):
        ...
        root.geometry('400x200')  # set new geometry
        ...
        self.inputBar= Frame(self.menu_frame,bg="")
        self.inputBar.pack(fill=BOTH,expand=YES)
        
        self.resetBar= Frame(self.menu_frame,bg="")
        self.resetBar.pack(fill=BOTH,expand=YES)
        ...
        self.inputtxt= Text(self.inputBar, height = 5, width = 15, bg = "light yellow")
        self.inputtxt.pack(expand=YES)
        
        self.resetButton = Button(self.resetBar, width=3, command=self.resetCount, background="red")
        self.resetButton.pack(expand=YES)
    ...
    def takeBoundedScreenShot(self, x1, y1, x2, y2):
        ...
        self.name=self.inputtxt.get(1.0,"end-1c")+str(self.count)
        fileName = self.name
        self.count+=1
        im.save("E:/Ejada Projects/Rajhi Bank CRM/Documentaion/Snapshots/" + fileName + ".png")
